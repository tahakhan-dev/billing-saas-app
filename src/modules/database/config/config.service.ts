...
export class ConfigService {
    ...
    public lofusingDotEnv() {
        try {
            ...
            console.error(error, '============ lofusingDotEnv Function ConfigService Database =============');
        }
    }
    ...
    private parseConfigFromEnv(env: NodeJS.ProcessEnv): ConfigData {
        try {
            ...
            console.error(error, '============ parseConfigFromEnv Function ConfigService Database =============');
        }
    }
    ...
    private parseDbConfigFromEnv(env: NodeJS.ProcessEnv): ConfigDBData {
        try {
            ...
            console.error(error, '============ parseDbConfigFromEnv Function ConfigService Database =============');
        }
    }
    ...
    public get(): Readonly<ConfigData> {
        try {
            ...
            console.error(error, '============ get Function ConfigService Database =============');
        }
    }
}
